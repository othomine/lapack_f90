...
!
               DO JR = 1, MIN( M+JKU, N ) + JKL - 1
                  ...
                  IF( JR < M ) THEN
                     ...
                     CALL DLAROT( .TRUE., JR > JKL, .FALSE., IL, C, &
...
!
                  ...
                  DO JCH = JR - JKL, 1, -JKL - JKU
                     IF( IR < M ) THEN
                        ...
                        call system_clock(count_rate=nb_periods_sec,count=S2_time)
                        open(file='results.out', unit=10, position = 'append')
                        write(10,'(A,F16.10,A)') 'Total time : DLARTG : ',&
                              real(S2_time-S1_time)/real(nb_periods_sec), ' s'
                        close(10)
#endif
                     END IF
...
!
               DO JC = 1, MIN( N+JKL, M ) + JKU - 1
                  ...
                  IF( JC < N ) THEN
                     ...
                     CALL DLAROT( .FALSE., JC > JKU, .FALSE., IL, C, &
...
!
               ...
               DO JC = MIN( M+JKU, N ) - 1, 1 - JKL, -1
                  ...
                  IF( JC > 0 ) THEN
                     ...
                     CALL DLAROT( .FALSE., .FALSE., JC+JKL < M, IL, &
...
!
               ...
               DO JR = MIN( N+JKL, M ) - 1, 1 - JKU, -1
                  ...
                  IF( JR > 0 ) THEN
                     ...
                     CALL DLAROT( .TRUE., .FALSE., JR+JKU < N, IL, &
