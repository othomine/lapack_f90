...
!
...
#endif
      CALL SSYMM( 'Left', UPLO, N, M, 1.0E+0, A, LDA, Z, LDZ, 0.0E+0, &
                  WORK, N )
#ifdef _TIMER
      ...
      call system_clock(count_rate=nb_periods_sec,count=S1_time)
#endif
      CALL SSYMM( 'Left', UPLO, N, M, 1.0E+0, B, LDB, Z, LDZ, -1.0E+0, &
                  WORK, N )
#ifdef _TIMER
      call system_clock(count_rate=nb_periods_sec,count=S2_time)
      open(file='results.out', unit=10, position = 'append')
...
!
      ...
      call system_clock(count_rate=nb_periods_sec,count=S1_time)
#endif
      CALL SSYMM( 'Left', UPLO, N, M, 1.0E+0, B, LDB, Z, LDZ, 0.0E+0, &
                  WORK, N )
#ifdef _TIMER
      call system_clock(count_rate=nb_periods_sec,count=S2_time)
      open(file='results.out', unit=10, position = 'append')
      ...
      call system_clock(count_rate=nb_periods_sec,count=S1_time)
#endif
      CALL SSYMM( 'Left', UPLO, N, M, 1.0E+0, A, LDA, WORK, N, -1.0E+0, Z, &
                  LDZ )
#ifdef _TIMER
      call system_clock(count_rate=nb_periods_sec,count=S2_time)
      open(file='results.out', unit=10, position = 'append')
...
!
      ...
      call system_clock(count_rate=nb_periods_sec,count=S1_time)
#endif
      CALL SSYMM( 'Left', UPLO, N, M, 1.0E+0, B, LDB, WORK, N, -1.0E+0, Z, &
                  LDZ )
#ifdef _TIMER
      call system_clock(count_rate=nb_periods_sec,count=S2_time)
      open(file='results.out', unit=10, position = 'append')
