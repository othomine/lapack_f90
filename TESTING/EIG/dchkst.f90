...
!
            ...
            DO I = 2, N
               ...
               IF( TEMP1 > 0.5D0 ) THEN
                  A( I-1, I ) = 0.5D0*SQRT( ABS( A( I-1, I-1 )*A( I, &
                                I ) ) )
                  A( I, I-1 ) = A( I-1, I )
               END IF
            ENDDO
...
!              Do test 17
!
            TEMP2 = 2.0D0*( 2.0D0*N-1.0D0 )*ULP*( 1.0D0+8.0D0*0.5D0**2 ) / ( 1.0D0-0.5D0 )**4
!
            TEMP1 = 0.0D0
            DO J = 1, N
