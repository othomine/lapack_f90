...
!> \verbatim
!>
!>    CONSTRUCT THE MODIFIED GIVENS TRANSFORMATION MATRIX H WHICH 0.E0S
!>    THE SECOND COMP1.E0NT OF THE 2-VECTOR  (SQRT(SD1)*SX1,SQRT(SD2)*>    SY2)**T.
!>    WITH SPARAM(1)=SFLAG, H HAS 1.E0 OF THE FOLLOWING FORMS..
!>
...
!>    OF SD1 AND SD2.  ALL ACTUAL SCALING OF DATA IS D1.E0 USING GAM.
!>
!> \endverbatim
!
!  Arguments:
