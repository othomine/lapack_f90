...
!        Form  H * C
!
      IF( TAU /= (0.0E+0,0.0E+0) ) THEN
!
!           w( 1:n ) = conjg( C( 1, 1:n ) )
!
         WORK(1:N) = CONJG(C(1,1:N))
!
...
!
         CALL CGEMV( 'No transpose', M, L, (1.0E+0,0.0E+0), C( 1, N-L+1 ), LDC, &
                     V, INCV, (1.0E+0,0.0E+0), WORK, 1 )
!
!           C( 1:m, 1 ) = C( 1:m, 1 ) - tau * w( 1:m )
!
         C( 1:M, 1 ) = C( 1:M, 1 ) - TAU * WORK( 1:M )
!
