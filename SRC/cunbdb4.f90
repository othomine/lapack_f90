...
!
      IF( I  ==  1 ) THEN
         ...
         C = COS( THETA(I) )
         S = SQRT(1.0E0-C**2)
         PHANTOM(1) = (1.0E+0,0.0E+0)
         PHANTOM(P+1) = (1.0E+0,0.0E+0)
...
!
   DO I = P + 1, Q
      X21(M-Q+I-P,I:Q) = CONJG(X21(M-Q+I-P,I:Q))
      CALL CLARFGP( Q-I+1, X21(M-Q+I-P,I), X21(M-Q+I-P,I+1), LDX21, &
                    TAUQ1(I) )
      X21(M-Q+I-P,I) = (1.0E+0,0.0E+0)
