...
!
            ...
            CALL CHERK( 'L', 'C', N1, N2, 1.0E+0, A( N1 ), N, 1.0E+0, &
                        A( 0 ), N )
            CALL CTRMM( 'L', 'U', 'N', 'N', N2, N1, (1.0E+0,0.0E+0), A( N ), N, &
                        A( N1 ), N )
...
!
            ...
            CALL CHERK( 'L', 'N', N1, N2, 1.0E+0, A( 0 ), N, 1.0E+0, &
                        A( N2 ), N )
            CALL CTRMM( 'R', 'U', 'C', 'N', N1, N2, (1.0E+0,0.0E+0), A( N1 ), N, &
                        A( 0 ), N )
...
!
            ...
            CALL CHERK( 'U', 'N', N1, N2, 1.0E+0, A( N1*N1 ), N1, 1.0E+0, &
                        A( 0 ), N1 )
            CALL CTRMM( 'R', 'L', 'N', 'N', N1, N2, (1.0E+0,0.0E+0), A( 1 ), N1, &
                        A( N1*N1 ), N1 )
...
!
            ...
            CALL CHERK( 'U', 'C', N1, N2, 1.0E+0, A( 0 ), N2, 1.0E+0, &
                        A( N2*N2 ), N2 )
            CALL CTRMM( 'L', 'L', 'C', 'N', N2, N1, (1.0E+0,0.0E+0), A( N1*N2 ), &
                        N2, A( 0 ), N2 )
...
!
            ...
            CALL CHERK( 'L', 'C', K, K, 1.0E+0, A( K+1 ), N+1, 1.0E+0, &
                        A( 1 ), N+1 )
            CALL CTRMM( 'L', 'U', 'N', 'N', K, K, (1.0E+0,0.0E+0), A( 0 ), N+1, &
                        A( K+1 ), N+1 )
...
!
            ...
            CALL CHERK( 'L', 'N', K, K, 1.0E+0, A( 0 ), N+1, 1.0E+0, &
                        A( K+1 ), N+1 )
            CALL CTRMM( 'R', 'U', 'C', 'N', K, K, (1.0E+0,0.0E+0), A( K ), N+1, &
                        A( 0 ), N+1 )
...
!
            ...
            CALL CHERK( 'U', 'N', K, K, 1.0E+0, A( K*( K+1 ) ), K, 1.0E+0, &
                        A( K ), K )
            CALL CTRMM( 'R', 'L', 'N', 'N', K, K, (1.0E+0,0.0E+0), A( 0 ), K, &
                        A( K*( K+1 ) ), K )
...
!
            ...
            CALL CHERK( 'U', 'C', K, K, 1.0E+0, A( 0 ), K, 1.0E+0, &
                        A( K*( K+1 ) ), K )
            CALL CTRMM( 'L', 'L', 'C', 'N', K, K, (1.0E+0,0.0E+0), A( K*K ), K, &
                        A( 0 ), K )
