...
!
   IF( N1 == 0 ) THEN
      CALL CTRMM( SIDE, 'Upper', TRANS, 'Non-Unit', M, N, (1.0E+0,0.0E+0), &
                  Q, LDQ, C, LDC )
      WORK( 1 ) = (1.0E+0,0.0E+0)
      RETURN
   ELSE IF( N2 == 0 ) THEN
      CALL CTRMM( SIDE, 'Lower', TRANS, 'Non-Unit', M, N, (1.0E+0,0.0E+0), &
                  Q, LDQ, C, LDC )
      WORK( 1 ) = (1.0E+0,0.0E+0)
      RETURN
   END IF
...
!
            ...
            CALL CTRMM( 'Left', 'Lower', 'No Transpose', 'Non-Unit', &
                        N1, LEN, (1.0E+0,0.0E+0), Q( 1, N2+1 ), LDQ, WORK, &
                        LDWORK )
!
!              Multiply top part of C by Q11.
!
            CALL CGEMM( 'No Transpose', 'No Transpose', N1, LEN, N2, &
                        (1.0E+0,0.0E+0), Q, LDQ, C( 1, I ), LDC, (1.0E+0,0.0E+0), WORK, &
                        LDWORK )
!
...
!
            ...
            CALL CTRMM( 'Left', 'Upper', 'No Transpose', 'Non-Unit', &
                        N2, LEN, (1.0E+0,0.0E+0), Q( N1+1, 1 ), LDQ, &
                        WORK( N1+1 ), LDWORK )
!
!              Multiply bottom part of C by Q22.
!
            CALL CGEMM( 'No Transpose', 'No Transpose', N2, LEN, N1, &
                        (1.0E+0,0.0E+0), Q( N1+1, N2+1 ), LDQ, C( N2+1, I ), LDC, &
                        (1.0E+0,0.0E+0), WORK( N1+1 ), LDWORK )
!
...
!
            ...
            CALL CTRMM( 'Left', 'Upper', 'Conjugate', 'Non-Unit', &
                        N2, LEN, (1.0E+0,0.0E+0), Q( N1+1, 1 ), LDQ, WORK, &
                        LDWORK )
!
...
!
            ...
            CALL CTRMM( 'Left', 'Lower', 'Conjugate', 'Non-Unit', &
                        N1, LEN, (1.0E+0,0.0E+0), Q( 1, N2+1 ), LDQ, &
                        WORK( N2+1 ), LDWORK )
!
!              Multiply bottom part of C by Q22**H.
!
            CALL CGEMM( 'Conjugate', 'No Transpose', N1, LEN, N2, &
                        (1.0E+0,0.0E+0), Q( N1+1, N2+1 ), LDQ, C( N1+1, I ), LDC, &
                        (1.0E+0,0.0E+0), WORK( N2+1 ), LDWORK )
!
!              Copy everything back.
!
            CALL CLACPY( 'All', M, LEN, WORK, LDWORK, C( 1, I ), &
...
!
            ...
            CALL CTRMM( 'Right', 'Upper', 'No Transpose', 'Non-Unit', &
                        LEN, N2, (1.0E+0,0.0E+0), Q( N1+1, 1 ), LDQ, WORK, &
                        LDWORK )
!
!              Multiply left part of C by Q11.
!
            CALL CGEMM( 'No Transpose', 'No Transpose', LEN, N2, N1, &
                        (1.0E+0,0.0E+0), C( I, 1 ), LDC, Q, LDQ, (1.0E+0,0.0E+0), WORK, &
                        LDWORK )
!
...
!
            ...
            CALL CTRMM( 'Right', 'Lower', 'No Transpose', 'Non-Unit', &
                        LEN, N1, (1.0E+0,0.0E+0), Q( 1, N2+1 ), LDQ, &
                        WORK( 1 + N2*LDWORK ), LDWORK )
!
!              Multiply right part of C by Q22.
!
            CALL CGEMM( 'No Transpose', 'No Transpose', LEN, N1, N2, &
                        (1.0E+0,0.0E+0), C( I, N1+1 ), LDC, Q( N1+1, N2+1 ), LDQ, &
                        (1.0E+0,0.0E+0), WORK( 1 + N2*LDWORK ), LDWORK )
!
!              Copy everything back.
!
...
!
            ...
            CALL CTRMM( 'Right', 'Lower', 'Conjugate', 'Non-Unit', &
                        LEN, N1, (1.0E+0,0.0E+0), Q( 1, N2+1 ), LDQ, WORK, &
                        LDWORK )
!
...
!
            ...
            CALL CTRMM( 'Right', 'Upper', 'Conjugate', 'Non-Unit', &
                        LEN, N2, (1.0E+0,0.0E+0), Q( N1+1, 1 ), LDQ, &
                        WORK( 1 + N1*LDWORK ), LDWORK )
!
!              Multiply right part of C by Q22**H.
!
            CALL CGEMM( 'No Transpose', 'Conjugate', LEN, N2, N1, &
                        (1.0E+0,0.0E+0), C( I, N2+1 ), LDC, Q( N1+1, N2+1 ), LDQ, &
                        (1.0E+0,0.0E+0), WORK( 1 + N1*LDWORK ), LDWORK )
!
!              Copy everything back.
!
            CALL CLACPY( 'All', LEN, N, WORK, LDWORK, C( I, 1 ), &
