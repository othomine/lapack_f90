...
!
      CALL CGEMM('C','N',NNB,NNB,CUT,(1.0E+0,0.0E+0),A(1,CUT+1),LDA, &
...
!        U01 =  U00**H*invD0*U01
!
      CALL CTRMM('L',UPLO,'C','U',CUT, NNB, (1.0E+0,0.0E+0),A,LDA,WORK,N+NB+1)
...
!
      CALL CGEMM('C','N',NNB,NNB,N-NNB-CUT,(1.0E+0,0.0E+0),A(CUT+NNB+1,CUT+1) &
